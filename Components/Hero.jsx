...
const Hero = ({ title, createCampaign }) => {
    ...
    const createNewCampaign = async (e) => {
        ...
        try {
            await createCampaign(campaign); // Call the createCampaign function
        ...
        <div className="relative">
            ...
            <div className="relative bg-opacity-75 backgroundMain">
                ...
                >
                    <path
                        fill="currentColor"
                        d="M-164 13L-104 39.7C-44 66 76 120 196 141C316 162 436 152 556 119.7C676 88 796 34 916 13C1036 -8 1156 2 1216 7.7L1276 13V162.5H1216C1156 162.5 1036 162.5 916 162.5C796 162.5 676 162.5 556 162.5C436 162.5 316 162.5 196 162.55C76 162.5 -44 162.5 -104 162.5H-164V13Z"
                    />
                </svg>
                    ...
                    <div className="flex flex-col items-center justify-between xl:flex-row">
                        <div className="w-full max-w-xl mb-12 xl:mb-0 xl:pr-16 xl:w-7/12">
                            ...
                            <p className="max-w-xl mb-4 text-base text-gray-200 md:text-lg">
                                Write something might edit later
                            </p>
                            <a
                                href="/"
                                aria-label=""
                                className="inline-flex items-center font-bold transition-colors duration-200 text-teal-accent-400 hover:text-teal-accent-700 text-gray-200"
                            >
                                Learn More
                                <svg
                                    ...
                                    viewBox="0 0 12 12"
                                >
                                    <path d="M9.707,5.293l-5-5A1,1,0,0,0,3.293,1.707L7.586,6,3.293,10.293a1,1,1,0,1,0,1.414,1.414,1.414l5-5A1,1,0,0,0,9.707,5.293Z" />
                                </svg>
                            </a>
                        </div>
